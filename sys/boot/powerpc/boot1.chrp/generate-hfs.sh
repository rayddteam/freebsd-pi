...
# $FreeBSD: projects/armv6/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226747 2011-10-25 19:47:28Z cognet $
...
echo '# $FreeBSD: projects/armv6/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226747 2011-10-25 19:47:28Z cognet $' >> Makefile.hfs
...
echo '$FreeBSD: projects/armv6/sys/boot/powerpc/boot1.chrp/generate-hfs.sh 226747 2011-10-25 19:47:28Z cognet $' >> $OUTPUT_FILE.bz2.uu
