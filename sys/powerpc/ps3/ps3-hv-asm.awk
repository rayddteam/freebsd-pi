...
# $FreeBSD: projects/armv6/sys/powerpc/ps3/ps3-hv-asm.awk 232120 2012-02-24 18:39:55Z cognet $

BEGIN {
	printf("/* $FreeBSD: projects/armv6/sys/powerpc/ps3/ps3-hv-asm.awk 232120 2012-02-24 18:39:55Z cognet $ */\n\n");
